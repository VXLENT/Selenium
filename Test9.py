...
#выбор магазина
button_enter = browser.find_element(By.CSS_SELECTOR, "#item5 > span").click()
time.sleep(5)
button_enter = browser.find_element(By.CSS_SELECTOR, "body > div.no_fix_header.body > div.big_map_wrap > div.layer.big_map_shops > div.scroll > div > div > div > div > div.item.shop.visible.first > div:nth-child(1) > div").click()
time.sleep(5)

proverka = browser.find_element(By.CSS_SELECTOR, "body > div.no_fix_header.body > div.big_map_wrap > div.layer.big_map_shop > div.scroll.jspScrollable > div > div.jspPane > div > div.item.shop > div:nth-child(1) > div").text
